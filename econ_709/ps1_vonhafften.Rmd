...
Proof: CDFs have three unique properties: (1) $\lim_{x \to \infty} F(X) = 1, \lim_{x \to -\infty} F(X) = 0$, (2) $F(x)$ is non-decreasing, (3), $F(x)$ is right-continuous, that is $\lim_{x \to x_0^+}$.
