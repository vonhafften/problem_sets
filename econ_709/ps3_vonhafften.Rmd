...
Note that the integral of a Gaussian function is

$$
\int_{-\infty}^{\infty} \exp(-ax^2+bx+c)dx= \sqrt{\frac{\pi}{a}} \exp\Bigg(\frac{b^2}{4a}+c\Bigg).
$$
...
&= \int_{-\infty}^{\infty} \frac{1}{2 \pi \sigma_X \sigma_Y \sqrt{1-\rho^2}} \exp\Bigg(-\frac{1}{2(1-\rho^2)}\Bigg(\frac{x^2}{\sigma_X^2}-\frac{2\rho xy}{\sigma_X\sigma_Y}+\frac{y^2}{\sigma_Y^2}\Bigg)\Bigg) dx \\
&= \frac{1}{2 \pi \sigma_X \sigma_Y \sqrt{1-\rho^2}} \int_{-\infty}^{\infty} \exp\Bigg(-\frac{1}{2\sigma_X^2(1-\rho^2)}x^2 + \frac{\rho y }{\sigma_X\sigma_Y(1-\rho^2)}x - \frac{y^2}{2\sigma_Y^2(1-\rho^2)}\Bigg)  dx \\
&= \frac{1}{2 \pi \sigma_X \sigma_Y \sqrt{1-\rho^2}} \int_{-\infty}^{\infty} \exp\Bigg(-ax^2 + bx + c \Bigg) dx \\
\end{align*}

where $a=(2\sigma_X^2(1-\rho^2))^{-1}$, $b = \rho y (\sigma_X\sigma_Y(1-\rho^2))^{-1}$, and $c=-y^2(2\sigma_Y^2(1-\rho^2))^{-1}$. Therefore, using the Gaussian integral formula above:

\begin{align*}
F_Y(y) &= \frac{1}{2 \pi \sigma_X \sigma_Y \sqrt{1-\rho^2}} \sqrt{\pi 2\sigma_X^2(1-\rho^2)} \exp\Bigg(\frac{2\sigma_X^2(1-\rho^2) (\rho y)^2}{4(\sigma_X\sigma_Y(1-\rho^2))^2} - \frac{y^2}{2\sigma_Y^2(1-\rho^2)}\Bigg) \\
&=  \frac{1}{ \sigma_Y\sqrt{2\pi}} \exp \Bigg(\frac{\rho^2y^2}{2\sigma_Y^2(1-\rho^2)}- \frac{y^2}{2\sigma_Y^2(1-\rho^2)}\Bigg) \\
&=  \frac{1}{ \sigma_Y\sqrt{2\pi}} \exp \Bigg(-\frac{y^2}{2\sigma_Y^2}\Bigg) \\
\end{align*}

Thus, $Y \sim Normal(0, \sigma_Y^2)$.  
...
&= \frac{1}{2 \pi \sigma_X \sigma_Y \sqrt{1-\rho^2}} \int_{-\infty}^{\infty} \exp\Bigg(-\frac{1}{2\sigma_Y^2(1-\rho^2)}y^2 + \frac{\rho x }{\sigma_X\sigma_Y(1-\rho^2)}y - \frac{x^2}{2\sigma_X^2(1-\rho^2)}\Bigg)  dy \\
&= \frac{1}{2 \pi \sigma_X \sigma_Y \sqrt{1-\rho^2}} \sqrt{\pi 2\sigma_Y^2(1-\rho^2)} \exp\Bigg(\frac{2\sigma_Y^2(1-\rho^2) (\rho x)^2}{4(\sigma_Y\sigma_X(1-\rho^2))^2} - \frac{x^2}{2\sigma_X^2(1-\rho^2)}\Bigg) \\
&=  \frac{1}{ \sigma_X\sqrt{2\pi}} \exp \Bigg(\frac{\rho^2x^2}{2\sigma_X^2(1-\rho^2)}- \frac{x^2}{2\sigma_X^2(1-\rho^2)}\Bigg) \\
&=  \frac{1}{ \sigma_X\sqrt{2\pi}} \exp \Bigg(-\frac{x^2}{2\sigma_X^2}\Bigg) \\
\end{align*}

Thus, $X \sim Normal(0, \sigma_X^2)$.
