...
(b) Extra challenge: Find the MLE $\hat{\theta}$ for $\theta$. This is challenging as it is not simply solving the FOC due to the nondifferentiability of the density function.
