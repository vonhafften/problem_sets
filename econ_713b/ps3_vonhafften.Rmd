...
The bank seeks to implement a high level of effort because the expected level of output with low effort is insufficient to cover its cost of funds.  If the entrepreneur exerts effort level $e_1$, her expected payoff is:
