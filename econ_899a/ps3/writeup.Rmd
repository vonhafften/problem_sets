...
Yes, the savings function for a worker at the model-age 20 is increasing in $a$ and increasing in $z$ (figure 3).
...
- Figure 2 shows the average value function by age.  The young (model-age of 10 or less) prefer the world without social security; everyone else preferred the world with social security.
