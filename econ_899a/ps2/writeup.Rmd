...
where $v(a, s)$ is the value function from the incomplete markets economy. Then the economywide welfare gain is:
...
What is $W^{INC} = \sum_{(a, s) \in A \times S} \mu(a, s) v(a, s)$?
...
What fraction of the population would favor changing to complete markets? That is, $\sum_{(a, s) \in A \times S} \one_{\{\lambda(a, s) \ge 0\}}(a, s) \mu(a, s)$.
