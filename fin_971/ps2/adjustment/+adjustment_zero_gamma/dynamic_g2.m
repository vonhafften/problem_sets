...
if T_flag
    T = adjustment_zero_gamma.dynamic_g2_tt(T, y, x, params, steady_state, it_);
end
g2_i = zeros(27,1);
g2_j = zeros(27,1);
g2_v = zeros(27,1);
...
g2_v(3)=g2_v(2);
g2_v(4)=(-(y(13)*(params(1)*y(12)*getPowerDeriv(y(4),params(1)-1,2)+(2*T(3)*2*T(3)*(params(4)*(-(T(2)*2*y(4)))*2*2*y(4)+2*T(3)*params(4)*(-(2*T(2)))-(params(4)*(-(T(2)*2*y(4)))*2*2*y(4)+T(4)*4))-(2*T(3)*params(4)*(-(T(2)*2*y(4)))-T(4)*2*2*y(4))*(2*T(3)*2*2*y(4)+2*T(3)*2*2*y(4)))/(2*T(3)*2*T(3)*2*T(3)*2*T(3)))));
g2_v(5)=(-(y(13)*(-(2*2*y(4)*params(4)*2*y(11)))/(2*T(3)*2*T(3))));
g2_v(6)=g2_v(5);
g2_v(7)=(-(y(13)*params(1)*T(9)));
g2_v(8)=g2_v(7);
g2_v(9)=(-T(10));
g2_v(10)=g2_v(9);
g2_v(11)=(-(1-params(3)));
g2_v(12)=g2_v(11);
g2_v(13)=(-(y(13)*2*params(4)/(2*T(3))));
g2_v(14)=(-(params(4)*2*y(11)/(2*T(3))));
g2_v(15)=g2_v(14);
