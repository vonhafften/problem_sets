...
= (\gamma - \rho ) w_i - \beta (w_i - w_j)^2 - \frac{\alpha w_i^2}{2} - \frac{\alpha w_i w_j }{2} 
$$

$$
\frac{\partial u_i}{\partial w_i} = \gamma - \rho - 2\beta (w_i - w_j)  - \alpha w_i - \frac{\alpha w_j }{2} 
$$
...
If $4\beta \ge \alpha$, then the game is supermodular.

(c) Find the symmetric pure-strategy Nash equilibrium.

In a symmetric pure-strategy Nash equilibrium, players have the same strategy $w_i=w_j$:

$$
u_i(w_i, w_i) 
= \gamma w_i - \beta (w_i - w_i)^2 - (\rho + \alpha w_i) w_i \\
= (\gamma - \rho) w_i - \alpha w_i^2 \\
$$

FOC [$w_i$]:

$$
0 = (\gamma - \rho) - 2\alpha w_i 
\implies w_i^* = \frac{\gamma - \rho}{2 \alpha}
$$
