...
Now, we turn to the location decision.  The total revenue of coffee shop 1 is:
...
\begin{align*}
0 &= -\frac{1}{18}c[3(x_1^*)^2 + 2x_1^*x_2 + 8x_1^* - x_2^2 + 4] \\
0 &= 3(x_1^*)^2 + (2x_2+ 8)x_1^* + (4 - x_2^2)\\
x_1^*(x_2) &= \frac{-(2x_2+ 8) \pm \sqrt{(2x_2+ 8)^2 - 4(3)(4 - x_2^2)}}{2(3)}\\
&= \frac{-2x_2- 8 + \sqrt{4x_2^2 + 32x_2 + 64 - 48 + 12x_2^2}}{6}\\
&= \frac{-2x_2- 8 + 4\sqrt{x_2^2 + 2x_2 + 1}}{6} \\
&= \frac{-x_2- 4 + 2(x_2 + 1)}{3}\\
&= \frac{x_2- 2}{3}
\end{align*}
...
\begin{align*}
0 &= \frac{1}{18}c(x_1^2 - 2x_1x_2^* - 3(x_2^*)^2 + 16(x_2^*) - 16) \\
\implies 
0 &= 3(x_2^*)^2 + (2x_1-16)x_2^* + (16 - x_1^2)  \\
x_2^*(x_1) &= \frac{-(2x_1-16) \pm \sqrt{(2x_1-16)^2 - 4(3)(16 - x_1^2)}}{2(3)}\\
&= \frac{16-2x_1 \pm \sqrt{(4x_1^2-64x_1+256) - 192 + 12x_1^2}}{6}\\
&= \frac{8-x_1 \pm 2\sqrt{x_1^2-4x_1+4}}{3} \\
&= \frac{8-x_1 \pm 2(x_1 - 2)}{3}\\
&= \frac{x_1 +4}{3}\\
\end{align*}
