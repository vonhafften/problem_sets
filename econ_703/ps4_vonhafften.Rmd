...
mtx$_W(T) = \begin{bmatrix} 1 & -1 \\ 2 & 3 \end{bmatrix}$.

(b) Find mtx$_V(T)$.

$P =$ mtx$_{W,V}(id)=\begin{bmatrix} 1 & -2 \\ -4 & 7 \end{bmatrix}$

$P^{-1} = \begin{bmatrix} -7 & -2 \\ -4 & -1 \end{bmatrix}$

mtx$_V(T) = P^{-1}$mtx$_W(T)P = \begin{bmatrix} -7 & -2 \\ -4 & -1 \end{bmatrix}\begin{bmatrix} 1 & -1 \\ 2 & 3 \end{bmatrix}\begin{bmatrix} 1 & -2 \\ -4 & 7 \end{bmatrix} = \begin{bmatrix} -15 & 29 \\ -10 & 19 \end{bmatrix}$

(c) Find $T(1, -2)$ in the basis $V$.

mtx$_V(T)\begin{bmatrix} 1 \\ -2 \end{bmatrix} = \begin{bmatrix} -15 & 29 \\ -10 & 19 \end{bmatrix}\begin{bmatrix} 1 \\ -2 \end{bmatrix}=\begin{bmatrix} -73 \\ -48 \end{bmatrix}$
