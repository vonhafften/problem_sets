...
For (ii), since $g$, $h_1$, and $h_2$ are continuous functions, $f$ is a continuous function.\footnote{For $\varepsilon > 0$,...}
...
## (5) Consider the set $X = \{-1, 0, 1\}$ and the space of all funcitons on $X$, $F_X = \{f: X \to \mathbb{R}\}$.
