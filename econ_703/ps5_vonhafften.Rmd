...
Define $X = \{(x, y) \in \R^2 : ||(x, y)||_\infty=1\}=\{(1, w), (x, 1), (-1, y), (-1, z) : w, x, y, z \in [-1, 1]\}$.  Since the linear transformation is increase in $x, y$, it is maximized at $(1, 1)$.

Thus, $||T|| = \sup\{X\}=\max\{6, 15\}=15$.
