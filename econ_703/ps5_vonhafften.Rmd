...
Proof: We show that $(||(x, y)||_2)^2$ in $W$ equals $(||(x, y)||_2)^2$ in $V$: 

\begin{align*}
\Bigg( \Bigg| \Bigg| x \begin{pmatrix} a_1 \\ a_2 \end{pmatrix} + y \begin{pmatrix} b_1 \\ b_2 \end{pmatrix} \Bigg|\Bigg|_2 \Bigg)^2
&= \Bigg( \Bigg| \Bigg| \begin{pmatrix} xa_1 + yb_1 \\ xa_2+yb_2 \end{pmatrix} \Bigg|\Bigg|_2 \Bigg)^2 \\
&= (x a_1 + y b_1)^2 + (x a_2 + y b_2)^2 \\
&= x^2 a_1^2 + y^2 b_1^2 + 2 a_1 b_1 x y + x^2 a_2^2 + y^2 b_2^2 + 2 a_2 b_2 x y \\
&= x^2 (a_1^2 + a_2^2) + y^2 (b_1^2 + b_2^2) + 2 (a_1 b_1 + a_2 b_2) x y \\
&= x^2(1) + y^2(1) + 2 (0) x y \\
&= x^2 + y^2 \\
\Bigg( \Bigg| \Bigg| x \begin{pmatrix} 1 \\ 0 \end{pmatrix} + y \begin{pmatrix} 0 \\ 1 \end{pmatrix} \Bigg|\Bigg|_2 \Bigg)^2
&= \Bigg( \Bigg| \Bigg| \begin{pmatrix} x \\ y \end{pmatrix} \Bigg|\Bigg|_2\Bigg)^2 \\
&= x^2 + y^2
\end{align*}

Thus, the Euclidean norm of any vector in $\R^2$ is the same in $W$ and $V$. $\square$
