...
5. 2.8 Suppose that $Y$ is discrete-valued, taking values only on the non-negative integers, and the conditional distribution of $Y$ given $X = x$ is Poisson:
...
(b) Show that $\hat{\mu}_k$ is unbaised for $\mu_k$.
...
Theorem 4.5 Generalized Guass-Markov
