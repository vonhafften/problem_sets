...
$$
\frac{\hat{\mu}_{2k} - \hat{\mu}_k^2}{n}  = \frac{\sum_{i=1}^n Y_i^{2k} - (\sum_{i=1}^n Y_i^{k})^2}{n}
$$
...
$$
E[\bar{Y}^2] = \var[\bar{Y}] + E[\bar{Y}]^2=\frac{\sigma^2}{n}+\mu^2
$$

$$
E[\bar{Y}^3] 
= E\Bigg[\Bigg(\frac{1}{n}\sum_{i=1}^n Y_i\Bigg)^3\Bigg]
= \frac{1}{n^3}E\Bigg[\sum_{i=1}^n\sum_{j=1}^n\sum_{k=1}^n Y_iY_jY_k\Bigg]
= \frac{1}{n^3} E\Bigg[\sum_{i=1}^n  Y_i^3 + \sum_{i=1}^n\sum_{j\neq i}^n Y_iY_j^2 + \sum_{i=1}^n\sum_{j \neq i}^n\sum_{k \neq i, k \neq j}^n Y_iY_jY_k \Bigg]
$$

$$
E[(\bar{Y} - \mu)^3] \\
= E[(\bar{Y} - \mu)^3]\\
= E[\bar{Y}^3 -3\mu\bar{Y}^2 +3\mu^2\bar{Y} - \mu^3]\\
= E[\bar{Y}^3] -3\mu E[\bar{Y}^2] +3\mu^2 E[ \bar{Y} ] - \mu^3
$$
