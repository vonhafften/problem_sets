...
4. Let the monetary policy be described by the Taylor rule $i_t=\varphi x_t+u_t$. What restrictionson the coefficient $\phi_x$ ensure uniqueness of the equilibrium?
