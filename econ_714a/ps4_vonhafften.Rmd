...
The total cost for firm $i$ in sector $k$ is $WL_{ik} = \frac{WC_{ik}}{A_{ik}}$, which implies that the marginal cost is $\frac{W}{A_{ik}}$

Firm $i$'s mark-up is the ratio of their price to their marginal cost:
...
# p_ik_0 starts at marginal cost pricing
p_ik_0 <- w/a
p_ik_1 <- p_ik_0
