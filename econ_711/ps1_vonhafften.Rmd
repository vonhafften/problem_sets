...
Consider price vectors $p=(1, 1, 1)$ and $p'=(2, 1, 1)$ as well as production set $Y=\{y, z\}$ where $y=(-5, -1, 10)$ and $z=(-1, -7, 11)$.  Notice that $\Delta p_1 = 1$, $\Delta p_2 = \Delta p_3 = 0$, and $\Delta y_3 = 1$. When the firm faces prices $p$, it chooses production plan $y$ because $p \cdot y < p \cdot z$ ($p \cdot y = -5-1+10=4$ and $p \cdot z = -1-7+11=3$).  When the firm faces prices $p'$, it chooses production plan $z$ because $p' \cdot y > p' \cdot z$ ($p' \cdot y = -10-1+10=-1$ and $p \cdot z = -2-7+11=2$).
