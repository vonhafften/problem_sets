...
Proof: Define $p=(p_1, p_2, p_3)$ and $p'=(\alpha p_1, \alpha p_2, p_3)$ where $\alpha > 1$ and $p_3 > 0$. Based on the optimal supply coorespondences being homogeneous of order 0,
