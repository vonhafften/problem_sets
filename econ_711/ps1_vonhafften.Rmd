...
If $p_1, p_2$ both increase by 10% and $p_3>0$, $y_3$ cannot increase.\footnote{If $p_3 = 0$, the optimal supply coorespondences are homogeneous of order 0 implies that
...
Proof: Define $p=(p_1, p_2, p_3)$ and $p'=(\alpha p_1, \alpha p_2, p_3)$ where $\alpha > 1$ and $p_3 > 0$. Again, based on the optimal supply coorespondences being homogeneous of order 0,
