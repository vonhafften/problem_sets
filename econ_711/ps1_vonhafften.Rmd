...
Proof: Define $p=(p_1, p_2, p_3)$ and $p'=(\alpha p_1, \alpha p_2, p_3)$ where $\alpha > 1$. Consider $p_3 = 0$. Optimal supply coorespondences are homogeneous of order 0, so
...
Thus, $y_3$ cannot increase.  Consider $p_3 > 0$. Again, based on the optimal supply coorespondences being homogeneous of order 0,
...
where $p''=(p_1, p_2, (1/\alpha)p_3)$.  Thus, the set of optimal production plans is the same under $p'$ and $p''$.  Define $\Delta p=p''-p=(0, 0, \frac{1-\alpha}{\alpha}p_3)$. Because $\alpha > 1$, $\Delta p_3 < 0$.  By the law of supply, $\Delta p \cdot \Delta y \ge 0 \implies \Delta y_3 \Delta p_3 \ge 0 \implies \Delta y_3 \le 0$. $\square$
