...
Proof:  Fixing $w$, choose $q, q'$ from the domain of $c$.  Define $z \in Z^*(q)$, $z' \in Z^*(q')$, and $\tilde{z} \in Z^*(tq+(1-t)q')$ for $t \in (0, 1)$.  By the concavity of $f$,
