...
\begin{align*}
Y^*(p) = \Bigg\{(y_1, y_2) : y_1 = -\Bigg(\frac{2p_2B}{3p_1}\Bigg)^3, y_2 = B^3\Bigg(\frac{2p_2}{3p_1}\Bigg)^2 \Bigg \} \implies y(p) = \Bigg(-\Bigg(\frac{2p_2B}{3p_1}\Bigg)^3, B^3\Bigg(\frac{2p_2}{3p_1}\Bigg)^2\Bigg)
\end{align*}
