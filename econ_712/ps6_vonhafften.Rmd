...
Conditional that the government plays $y_{L}$, the individual household cannot do better off than playing $\xi_{L}$ whatever is played by the aggregate household. So it plays $\xi_{L}$ and, by consistency, the aggregate household plays $x_{L}$.
...
Conditional that the government plays $y_{H}$, the individual household cannot do better off than playing $\xi_{H}$ whatever is played by the aggregate household. So it plays $\xi_{H}$ and, by consistency, the aggregate household plays $x_{H}$.
...
Now let's consider the individual household problem. As we see in the table above, if the government plays $y_{LL}$, the payoffs of the individual household plays $\xi_{LL}$ and, by consistency, the aggregate household plays $x_{LL}$. Thus, we have no commitment equilibrium at $(\xi_{LL}, x_{LL}, y_{LL})$.

As we see from the other table above, if the government play $y_L$, the individual household cannot do better off than playing $\xi_L$.  Thus, individual household plays $\xi_L$, and by consistency, the aggregate household plays $x_L$.  So there is second no commitment equilibrium at $(\xi_{L}, x_{L}, y_{L})$.
