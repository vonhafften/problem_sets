...
The system has a saddle path because the absolute value of one eigenvalue is greater than one and the absolute value of the other eigenvalue is less than one. The saddle path is $(k_t, c_t)$ where $x_1 = 0$.
