...
text("p_t/p_(t+1) = -infty", x=.75, y=5.5, col = "red")
text("p_t/p_(t+1) = 0", x=3.5, y=2.5, col = "red")
text("p_t/p_(t+1) = -1", x=3.25, y=.5, col = "red")
text("Indifference Curves", x=3.25, y=3.5, col = "blue")
