...
For standard CRRA preferences, we found that the stochastic discount factor is $\beta \Big( \frac{c_{t+1}}{c_{t}}\Big)^{-\gamma}$.  Thus, the price of a risk-free bond is $E_t \Big[\beta \Big( \frac{c_{t+1}}{c_{t}}\Big)^{-\gamma}\Big]$ and the risk-free return is $1/E_t \Big[\beta  \Big( \frac{c_{t+1}}{c_{t}}\Big)^{-\gamma} \Big]$.
...
With CRRA preferences, the payoff of the claim to the Lucas tree is the same, but the stochastic discount factor is $\beta \Big( \frac{c_{t+1}}{c_{t}}\Big)^{-\gamma}$.
