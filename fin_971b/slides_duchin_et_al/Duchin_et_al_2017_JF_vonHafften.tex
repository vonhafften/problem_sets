...
\item Use two-stage least squares to exploit the variation in the portfolio size due to unexpected cash flow shocks. \hyperlink{unexpected}{\beamerskipbutton{More}}
\end{itemize}
